...
?>
    ...
    <div class="list">
    <br> <span style="font-size: 24px"> <b>Add Fleet to Results</b> </span>
 <div class="details">

   <?php
  
  $ships = array();
  $sql = "Select name from ships order by name";
  $result = mysql_query($sql) or die("Unable to select: ".mysql_error());
  while($row = mysql_fetch_row($result)){
  array_push($ships, $row[0]);
  }

  echo "<datalist id='ships'>";
  foreach($ships as $pilot){
...
<br>
Fleet ID:<input type='number' id='s' style='width: 4em' min='1' max='9999'>
<br>
<input type='submit' value='Submit New Result' class='submit'/>
<span class="error" style="display:none; color: red"><br> Error adding Fleet </span>
<span class="success" style="display:none; color: green"><br> Added Successfully</span>
<br>Only use the Fleet Id field when using the 's' value from the URL of the matching fleet page, otherwise submit new fleet info below.
<hr>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ship 1:&nbsp;<input id='p1' type='text' list='ships' />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ship 2:&nbsp;<input id='p2' type='text' list='ships' />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ship 3:&nbsp;<input id='p3' type='text' list='ships' />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ship 4:&nbsp;<input id='p4' type='text' list='ships' />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ship 5:&nbsp;<input id='p5' type='text' list='ships' />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ship 6:&nbsp;<input id='p6' type='text' list='ships' />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ship 7:&nbsp;<input id='p7' type='text' list='ships' />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ship 8:&nbsp;<input id='p8' type='text' list='ships' />
