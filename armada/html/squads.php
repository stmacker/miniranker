...
<body bgcolor="black">
  ...
  <br>
  <div class="details">
Below is a list of the top fleets based on current data, select a squad to see more information on what tournaments it placed in.
<br><br>
...
if ($f == 0){
  ...
  foreach($squads as $key => $squad) {
    ...
    echo "<tr><td><span style='font-size: 12px'>". round($squad[1] / $top * 100) ." - </span><br>";
