...
if($_POST)
{
	...
	if(!is_null($p1) && $p1 != ''){
			...
			$sql = "select id from pilots where name = '". $p1 ."'";
			...
			if(!empty($p1upgrades)){
				...
				$sql = "select id from builds where pilot_id = ". $p1id ." and upgrades = '". implode(',',$p1upgrades) ."'";
				$result = mysql_query($sql) or die("Unable to select: ".mysql_error());
				$row = mysql_fetch_row($result);
				$p1build = $row[0];
					
				if(is_null($p1build) || $p1build == ''){
					mysql_query("insert into builds(pilot_id, upgrades) values (".$p1id.",'".implode(',',$p1upgrades)."')") or die("Unable to select: ".mysql_error());
				...
				$sql = "select id from builds where pilot_id = ". $p1id ." and upgrades is null";
				$result = mysql_query($sql) or die("Unable to select: ".mysql_error());
				$row = mysql_fetch_row($result);
				$p1build = $row[0];
			}
	...
	if(!is_null($p2) && $p2 != ''){
			...
			$sql = "select id from pilots where name = '". $p2 ."'";
    		$result = mysql_query($sql) or die("Unable to select: ".mysql_error());
    		$row = mysql_fetch_row($result);
    		$p2id = $row[0];
			...
			if(!empty($p2upgrades)){
				...
				$sql = "select id from builds where pilot_id = ". $p2id ." and upgrades = '". implode(',',$p2upgrades) ."'";
				$result = mysql_query($sql) or die("Unable to select: ".mysql_error());
				$row = mysql_fetch_row($result);
				$p2build = $row[0];
					
				if(is_null($p2build) || $p2build == ''){
					mysql_query("insert into builds(pilot_id, upgrades) values (".$p2id.",'".implode(',',$p2upgrades)."')") or die("Unable to select: ".mysql_error());
				...
				$sql = "select id from builds where pilot_id = ". $p2id ." and upgrades is null";
				$result = mysql_query($sql) or die("Unable to select: ".mysql_error());
				$row = mysql_fetch_row($result);
				$p2build = $row[0];
			}
	...
	if(!is_null($p3) && $p3 != ''){
			...
			$sql = "select id from pilots where name = '". $p3 ."'";
    		$result = mysql_query($sql) or die("Unable to select: ".mysql_error());
    		$row = mysql_fetch_row($result);
    		$p3id = $row[0];
			...
			if(!empty($p3upgrades)){
				...
				$sql = "select id from builds where pilot_id = ". $p3id ." and upgrades = '". implode(',',$p3upgrades) ."'";
				$result = mysql_query($sql) or die("Unable to select: ".mysql_error());
				$row = mysql_fetch_row($result);
				$p3build = $row[0];
					
				if(is_null($p3build) || $p3build == ''){
					mysql_query("insert into builds(pilot_id, upgrades) values (".$p3id.",'".implode(',',$p3upgrades)."')") or die("Unable to select: ".mysql_error());
				...
				$sql = "select id from builds where pilot_id = ". $p3id ." and upgrades is null";
				$result = mysql_query($sql) or die("Unable to select: ".mysql_error());
				$row = mysql_fetch_row($result);
				$p3build = $row[0];
			}
	...
	if(!is_null($p4) && $p4 != ''){
			...
			$sql = "select id from pilots where name = '". $p4 ."'";
    		$result = mysql_query($sql) or die("Unable to select: ".mysql_error());
    		$row = mysql_fetch_row($result);
    		$p4id = $row[0];
			...
			if(!empty($p4upgrades)){
				...
				$sql = "select id from builds where pilot_id = ". $p4id ." and upgrades = '". implode(',',$p4upgrades) ."'";
				$result = mysql_query($sql) or die("Unable to select: ".mysql_error());
				$row = mysql_fetch_row($result);
				$p4build = $row[0];
					
				if(is_null($p4build) || $p4build == ''){
					mysql_query("insert into builds(pilot_id, upgrades) values (".$p4id.",'".implode(',',$p4upgrades)."')") or die("Unable to select: ".mysql_error());
				...
				$sql = "select id from builds where pilot_id = ". $p4id ." and upgrades is null";
				$result = mysql_query($sql) or die("Unable to select: ".mysql_error());
				$row = mysql_fetch_row($result);
				$p4build = $row[0];
			}
	...
	if(!is_null($p5) && $p5 != ''){
			...
			$sql = "select id from pilots where name = '". $p5 ."'";
    		$result = mysql_query($sql) or die("Unable to select: ".mysql_error());
    		$row = mysql_fetch_row($result);
    		$p5id = $row[0];
			...
			if(!empty($p5upgrades)){
				...
				$sql = "select id from builds where pilot_id = ". $p5id ." and upgrades = '". implode(',',$p5upgrades) ."'";
				$result = mysql_query($sql) or die("Unable to select: ".mysql_error());
				$row = mysql_fetch_row($result);
				$p5build = $row[0];
					
				if(is_null($p5build) || $p5build == ''){
					mysql_query("insert into builds(pilot_id, upgrades) values (".$p5id.",'".implode(',',$p5upgrades)."')") or die("Unable to select: ".mysql_error());
				...
				$sql = "select id from builds where pilot_id = ". $p5id ." and upgrades is null";
				$result = mysql_query($sql) or die("Unable to select: ".mysql_error());
				$row = mysql_fetch_row($result);
				$p5build = $row[0];
			}
	...
	if(!is_null($p6) && $p6 != ''){
			...
			$sql = "select id from pilots where name = '". $p6 ."'";
    		$result = mysql_query($sql) or die("Unable to select: ".mysql_error());
    		$row = mysql_fetch_row($result);
    		$p6id = $row[0];
			...
			if(!empty($p6upgrades)){
				...
				$sql = "select id from builds where pilot_id = ". $p6id ." and upgrades = '". implode(',',$p6upgrades) ."'";
				$result = mysql_query($sql) or die("Unable to select: ".mysql_error());
				$row = mysql_fetch_row($result);
				$p6build = $row[0];
					
				if(is_null($p6build) || $p6build == ''){
					mysql_query("insert into builds(pilot_id, upgrades) values (".$p6id.",'".implode(',',$p6upgrades)."')") or die("Unable to select: ".mysql_error());
				...
				$sql = "select id from builds where pilot_id = ". $p6id ." and upgrades is null";
				$result = mysql_query($sql) or die("Unable to select: ".mysql_error());
				$row = mysql_fetch_row($result);
				$p6build = $row[0];
			}
	...
	if(!is_null($p7) && $p7 != ''){
			...
			$sql = "select id from pilots where name = '". $p7 ."'";
    		$result = mysql_query($sql) or die("Unable to select: ".mysql_error());
    		$row = mysql_fetch_row($result);
    		$p7id = $row[0];
			...
			if(!empty($p7upgrades)){
				...
				$sql = "select id from builds where pilot_id = ". $p7id ." and upgrades = '". implode(',',$p7upgrades) ."'";
				$result = mysql_query($sql) or die("Unable to select: ".mysql_error());
				$row = mysql_fetch_row($result);
				$p7build = $row[0];
					
				if(is_null($p7build) || $p7build == ''){
					mysql_query("insert into builds(pilot_id, upgrades) values (".$p7id.",'".implode(',',$p7upgrades)."')") or die("Unable to select: ".mysql_error());
				...
				$sql = "select id from builds where pilot_id = ". $p7id ." and upgrades is null";
				$result = mysql_query($sql) or die("Unable to select: ".mysql_error());
				$row = mysql_fetch_row($result);
				$p7build = $row[0];
			}
	...
	if(!is_null($p8) && $p8 != ''){
			...
			$sql = "select id from pilots where name = '". $p8 ."'";
    		$result = mysql_query($sql) or die("Unable to select: ".mysql_error());
    		$row = mysql_fetch_row($result);
    		$p8id = $row[0];
			...
			if(!empty($p8upgrades)){
				...
				$sql = "select id from builds where pilot_id = ". $p8id ." and upgrades = '". implode(',',$p8upgrades) ."'";
				$result = mysql_query($sql) or die("Unable to select: ".mysql_error());
				$row = mysql_fetch_row($result);
				$p8build = $row[0];
					
				if(is_null($p8build) || $p8build == ''){
					mysql_query("insert into builds(pilot_id, upgrades) values (".$p8id.",'".implode(',',$p8upgrades)."')") or die("Unable to select: ".mysql_error());
				...
				$sql = "select id from builds where pilot_id = ". $p8id ." and upgrades is null";
				$result = mysql_query($sql) or die("Unable to select: ".mysql_error());
				$row = mysql_fetch_row($result);
				$p8build = $row[0];
			}
